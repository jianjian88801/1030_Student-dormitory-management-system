  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">学生宿舍管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
																								...
																								<!-- <div v-if="tableName=='suguanyuan'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='suguanyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='suguanyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='suguanyuan'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='suguanyuan'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='suguanyuan'" class="input-group">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='suguanyuan'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='suguanyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                            ...
                                                            if((!this.ruleForm.gonghao) && `suguanyuan` == this.tableName){
        this.$message.error(`工号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `suguanyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                  if((!this.ruleForm.xingming) && `suguanyuan` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
                                                                                                                                                if(`suguanyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
