          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="损坏情况" prop="sunhuaiqingkuang">
          <el-input v-model="ruleForm.sunhuaiqingkuang" 
              placeholder="损坏情况" clearable  :readonly="ro.sunhuaiqingkuang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="损坏情况" prop="sunhuaiqingkuang">
              <el-input v-model="ruleForm.sunhuaiqingkuang" 
                placeholder="损坏情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zichansunhuai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichansunhuaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
