          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="清理时间" prop="qinglishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.qinglishijian" 
                type="date"
                placeholder="清理时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qinglishijian" label="清理时间" prop="qinglishijian">
              <el-input v-model="ruleForm.qinglishijian" 
                placeholder="清理时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="清理地点" prop="qinglididian">
          <el-input v-model="ruleForm.qinglididian" 
              placeholder="清理地点" clearable  :readonly="ro.qinglididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="清理地点" prop="qinglididian">
              <el-input v-model="ruleForm.qinglididian" 
                placeholder="清理地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='qinglishijian'){
            this.ruleForm.qinglishijian = obj[o];
	    this.ro.qinglishijian = true;
            continue;
          }
	            	            if(o=='qinglididian'){
            this.ruleForm.qinglididian = obj[o];
	    this.ro.qinglididian = true;
            continue;
          }
	                    }
                                                                              }
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        // 多级联动参数
                                                    info(id) {
      this.$http({
        url: `qingligonggongchangsuo/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qingligonggongchangsuo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qingligonggongchangsuoCrossAddOrUpdateFlag = false;
                  this.parent.search();
