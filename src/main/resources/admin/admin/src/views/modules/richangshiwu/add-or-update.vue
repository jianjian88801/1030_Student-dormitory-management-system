          ...
          <el-form-item class="input" v-if="ruleForm.shijian" label="时间" prop="shijian">
              <el-input v-model="ruleForm.shijian" 
                placeholder="时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加分事项" prop="jiafenshixiang">
          <el-input v-model="ruleForm.jiafenshixiang" 
              placeholder="加分事项" clearable  :readonly="ro.jiafenshixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加分事项" prop="jiafenshixiang">
              <el-input v-model="ruleForm.jiafenshixiang" 
                placeholder="加分事项" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评分标准" prop="pingfenbiaozhun">
          <el-input v-model="ruleForm.pingfenbiaozhun" 
              placeholder="评分标准" clearable  :readonly="ro.pingfenbiaozhun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评分标准" prop="pingfenbiaozhun">
              <el-input v-model="ruleForm.pingfenbiaozhun" 
                placeholder="评分标准" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
            continue;
	            	            ...
	            	            if(o=='jiafenshixiang'){
            this.ruleForm.jiafenshixiang = obj[o];
	    this.ro.jiafenshixiang = true;
            continue;
          }
	            	            if(o=='pingfenbiaozhun'){
            this.ruleForm.pingfenbiaozhun = obj[o];
	    this.ro.pingfenbiaozhun = true;
            continue;
          }
	            	            if(o=='beizhu'){
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springboott7kpr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `richangshiwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.richangshiwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
